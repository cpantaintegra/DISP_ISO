...
public class ServletAgendamiento extends HttpServlet {
    ...
    public void generaReporte(HttpServletRequest request, HttpServletResponse response) throws JRException, IOException, SQLException {
        ...
        try {
            String idAgendamientoStr = request.getParameter("agendamientoID");
            String idServicioStr = request.getParameter("servicioID");
            int idAgendamiento = Integer.parseInt(idAgendamientoStr);
            int idServicio = Integer.parseInt(idServicioStr);
            String ruta = request.getRealPath("/Reportes/AgendamientoInfo.jasper");
            ...
            parameters.put("agendamientoID", idAgendamiento);
            parameters.put("servicioID", idServicio);
            ...
            response.addHeader("Content-Disposition", "inline; filename=Informacion_Cita #" + idAgendamiento + ".pdf");
